...
#if defined(_MSC_VER)
#  define CPUKD_DLL_EXPORT __declspec(dllexport)
#  define CPUKD_DLL_IMPORT __declspec(dllimport)
#elif defined(__clang__) || defined(__GNUC__)
#  define CPUKD_DLL_EXPORT __attribute__((visibility("default")))
#  define CPUKD_DLL_IMPORT __attribute__((visibility("default")))
#else
#  define CPUKD_DLL_EXPORT
#  define CPUKD_DLL_IMPORT
#endif

// #if 1
# define CPUKD_INTERFACE /* nothing - currently not building any special 'owl.dll' */
// #else
// //#if defined(CPUKD_DLL_INTERFACE)
// #  ifdef owl_EXPORTS
// #    define CPUKD_INTERFACE CPUKD_DLL_EXPORT
// #  else
// #    define CPUKD_INTERFACE CPUKD_DLL_IMPORT
// #  endif
// //#else
// //#  define CPUKD_INTERFACE /*static lib*/
// //#endif
// #endif
...
#define CPUKD_NOTIMPLEMENTED throw std::runtime_error(std::string(__PRETTY_FUNCTION__)+" not implemented")

#ifdef WIN32
# define CPUKD_TERMINAL_RED ""
# define CPUKD_TERMINAL_GREEN ""
# define CPUKD_TERMINAL_LIGHT_GREEN ""
# define CPUKD_TERMINAL_YELLOW ""
# define CPUKD_TERMINAL_BLUE ""
# define CPUKD_TERMINAL_LIGHT_BLUE ""
# define CPUKD_TERMINAL_RESET ""
# define CPUKD_TERMINAL_DEFAULT CPUKD_TERMINAL_RESET
# define CPUKD_TERMINAL_BOLD ""

# define CPUKD_TERMINAL_MAGENTA ""
# define CPUKD_TERMINAL_LIGHT_MAGENTA ""
# define CPUKD_TERMINAL_CYAN ""
# define CPUKD_TERMINAL_LIGHT_RED ""
#else
# define CPUKD_TERMINAL_RED "\033[0;31m"
# define CPUKD_TERMINAL_GREEN "\033[0;32m"
# define CPUKD_TERMINAL_LIGHT_GREEN "\033[1;32m"
# define CPUKD_TERMINAL_YELLOW "\033[1;33m"
# define CPUKD_TERMINAL_BLUE "\033[0;34m"
# define CPUKD_TERMINAL_LIGHT_BLUE "\033[1;34m"
# define CPUKD_TERMINAL_RESET "\033[0m"
# define CPUKD_TERMINAL_DEFAULT CPUKD_TERMINAL_RESET
# define CPUKD_TERMINAL_BOLD "\033[1;1m"

# define CPUKD_TERMINAL_MAGENTA "\e[35m"
# define CPUKD_TERMINAL_LIGHT_MAGENTA "\e[95m"
# define CPUKD_TERMINAL_CYAN "\e[36m"
# define CPUKD_TERMINAL_LIGHT_RED "\033[1;31m"
#endif

#ifdef _MSC_VER
# define CPUKD_ALIGN(alignment) __declspec(align(alignment)) 
#else
# define CPUKD_ALIGN(alignment) __attribute__((aligned(alignment)))
#endif
...
namespace cpukd {
  namespace common {
    ...
    namespace polymorphic {
      ...
      inline __both__ float rsqrt(const float f)    { return 1.f/cpukd::common::polymorphic::sqrt(f); }
      inline __both__ double rsqrt(const double d)  { return 1./cpukd::common::polymorphic::sqrt(d); }
    }
